...
.section    .reset, "ax"
                movia r2, _start
                jmp r2 # reset이면, _start로 돌아가 프로그램 재시작
...
ON_EXT_INT: 
            andi r22, et, 0b10 # HW interrupt 일 경우, 
            beq r22, r0, NEXT # ipending의 두번째 bit가 0이면 넘어가고,
            call ON_KEY_PRESS # 1이면 ON_KEY_PRESS subroutine을 call 한다.
            br END_ISR # 끝나면 END_ISR branch로 가서 ISR 종료
NEXT:      andi r22, et, 0b1 # ipending의 첫번째 bit가 0이면 종료하고,
            beq r22, r0, END_ISR # 1이면 COUNT subroutine을 call 한다.
            call COUNT 
